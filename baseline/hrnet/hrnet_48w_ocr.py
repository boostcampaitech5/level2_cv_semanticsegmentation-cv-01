...
class HighResolutionNet(nn.Module):
    ...
    def forward(self, x):
        ...
        return torch.mean(torch.stack([out, out_aux], dim=0), dim=0)
...
def hrnet_48w_ocr(**kwargs):
    config_path = (
        "/opt/ml/level2_cv_semanticsegmentation-cv-01/baseline/hrnet/hrnet_48w_ocr.yaml"
    )
