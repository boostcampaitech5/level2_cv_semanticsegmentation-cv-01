_base_ = [
    '/opt/ml/level2_cv_semanticsegmentation-cv-01/baseline/mmsegmentation/configs/_base_/models/segformer_mit-b0.py',
    '/opt/ml/level2_cv_semanticsegmentation-cv-01/baseline/mmsegmentation/configs/_base_/datasets/cityscapes_1024x1024.py',
